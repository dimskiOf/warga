      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            ...
            <p>Register untuk menggunakan fitur-fitur dari web ini.</p>
          ...
          if (isset($success))
            ...
            ?>
              <div class="form-group-material">
                <input id="register-username" type="text" name="nama" required data-msg="Nama lengkap anda" class="input-material">
              ...
              <div class="form-group">
                  ...
                  <div class="col-xs-9">
                      <select name="hak" id="hak_id" required>
              ...
              <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <select name="ki" id="kelamin_input">
