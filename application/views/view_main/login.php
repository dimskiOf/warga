      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            <div class="logo text-uppercase"><strong class="text-primary"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url();?>assets/img/core-img/logotest.png" alt=""></a></strong></div>
            <p>Silahkan login menggunakan akun yang sudah terdaftar, untuk mengakses panel admin.</p>
