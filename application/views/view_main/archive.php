                                   ...
                                   <li><a href="#">News</a>
									...
									<li><a href="#">Live Streaming</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="archive.html">Radio</a></li>
                                            <li><a href="video-post.html">Vidio.com</a></li>
										</ul>
									</li>	
                                    <li><a href="#">Event</a>
                                        <ul class="dropdown">
                                            <li><a href="index.html">Kegiatan </a></li>
                                            <li><a href="archive.html">Media Partner</a></li>
                                            <li><a href="video-post.html">Sponsorship</a></li>
                                            <li><a href="single-post.html">Social Media</a></li>
                                        </ul>
                                    </li>
